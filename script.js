...
function updateCardSelect() {
    ...
    // Also avoid checking .innerHTML equality against a string, as it forces the browser to serialize the DOM subtree via C++, creating O(N) serialization overhead.
